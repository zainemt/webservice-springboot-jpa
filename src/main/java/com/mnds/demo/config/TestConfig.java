...
import com.mnds.demo.entities.Payment;
import com.mnds.demo.entities.Product;
import com.mnds.demo.entities.User;
import com.mnds.demo.entities.enums.OrderStatus;
import com.mnds.demo.repositories.CategoryRepository;
import com.mnds.demo.repositories.OrderItemRepository;
...
@Configuration //define para o spring que a classe será uma classe de configuração
@Profile("test") //define o perfil ao qual essa classe esta vinculado, nesse caso, somente será utilizada quando o perfil for o "test"
public class TestConfig implements CommandLineRunner{
	
	//Para que tenha-se a execução assim que a aplicação for iniciada, utiliza-se a implementação "CommandLineRunner"
